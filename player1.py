...
def PlayMusic():
    ...
    print(music_name[:-4])  # Print the music file name without the extension
...
Button(root, text="Browse Music", width=59, height=1, font=("calibri", 12, "bold"), fg="Black",
